			 SEMEVAL-2017 TASK 1 - Track 2

				 STS

	       Cross lingual Semantic Textual Similarity : English -Arabic
...
Cross lingual Semantic Textual Similarity: English-Arabic subtask (Track 2). 

The Training dataset contains the following:

  README.txt 		          this file
  en_ar.STS.MSRpar.txt		  tab separated input file with ids and sentence pairs
  en_ar.STS.MSRvid.txt		   "
  en_ar.STS.SMTeuroparl.txt	   "
...
The original sentence pairs (English) have been manually tagged with a number from 0 to 5. This is a subset of the data used in previous years for English STS. The data have been manually translated into Arabic for this task. For each pair of English sentences, two pairs of English-Arabic sentences are extracted. So the dataset size is twice as large as the original sentence pairs above (2176 pairs in total). 
