...
public class IRComparer {
	private static String index = "/tempo/indexes/EFE_UN_indexed";
	...
	public static double compare(String req1, String req2){
		...
		try {
			...
			if(SpanishSTSComparer.VERBOSE) System.err.println("searching queries:\nQ1: "+query1.toString()+"\nQ2: "+query2.toString());
		    ...
		    if(n_1 > 0 && n_2 > 0) {
		    	...
		    	for(String key : uniqueIDs) {
		    		...
		    		if(SpanishSTSComparer.VERBOSE) System.err.println("common doc: "+key+" s1: "+s1+" s2: "+s2);
