...
public class WordNet {
	...
	public static void init(){
		...
		System.err.println("Init WordNet 3.0 at "+wnhome);
		URL url;
		try {
	 ...
	 * @return
	 */
	public static Vector<String> getHypernyms(ISynsetID syn, int depth){
		Vector<String> result = new Vector<String>();
		ISynset ssyn = dict.getSynset(syn);
		
		if (ssyn == null) return result; 
